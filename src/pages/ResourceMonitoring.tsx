...
const ResourceMonitoring: React.FC = () => {
  ...
  const monitoringPoints: MonitoringPoint[] = [
    ...
    },
    {
      ...
      location: '邹城市工业园区',
      status: '正常',
      lastUpdate: '2025-06-12 09:30:45',
      value: 78.6,
      unit: 'AQI',
      trend: '上升',
      warningLevel: '轻度预警',
    },
    {
      ...
      location: '邹城市东南湖',
      status: '异常',
      lastUpdate: '2025-06-12 08:15:20',
      value: 68.3,
      unit: '%',
      trend: '下降',
      warningLevel: '中度预警',
  ...
  const warningRecords: WarningRecord[] = [
    {
      key: '1',
      id: 'ZC-YJ-20250610-001',
      pointId: 'ZC-JCD-004',
      pointName: '邹城市西部矿产资源监测点',
      type: '矿产资源',
      time: '2025-06-10 14:30:25',
      value: 72.5,
      threshold: 80.0,
      unit: '%',
      level: '中度预警',
    ...
    {
      key: '2',
      id: 'ZC-YJ-20250609-002',
      pointId: 'ZC-JCD-007',
      pointName: '邹城市东南湖泊水质监测点',
      type: '水资源',
      time: '2025-06-09 16:45:10',
      value: 65.8,
      threshold: 75.0,
      unit: '%',
      level: '中度预警',
    ...
    {
      key: '3',
      id: 'ZC-YJ-20250607-003',
      pointId: 'ZC-JCD-002',
      pointName: '邹城市东部土壤监测点',
      type: '土地资源',
      time: '2025-06-07 09:15:30',
      value: 82.5,
      threshold: 85.0,
      unit: '%',
      level: '轻度预警',
    ...
    {
      key: '4',
      id: 'ZC-YJ-20250605-004',
      pointId: 'ZC-JCD-005',
      pointName: '邹城市中心区空气质量监测点',
      type: '大气资源',
      time: '2025-06-05 12:50:15',
      value: 75.2,
      threshold: 70.0,
      unit: 'AQI',
      level: '轻度预警',
    ...
    {
      key: '5',
      id: 'ZC-YJ-20250602-005',
      pointId: 'ZC-JCD-006',
      pointName: '邹城市工业园区排放监测点',
      type: '大气资源',
      time: '2025-06-02 18:10:45',
      value: 82.6,
      threshold: 70.0,
      unit: 'AQI',
      level: '轻度预警',
